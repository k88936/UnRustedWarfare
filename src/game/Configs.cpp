...
std::unordered_map<std::string, MetaImage> Configs::images;
...
void Configs::parse_effects(const std::string& content, std::vector<std::string>& ans)
{
...
{
    const float scale_rw2sw = 1.0 / 40;
