...
void Game::init() {
    ...
    Game::units.push_back( new Unit(Configs::meta_units["m2a3"], QVector3D(0, 1, 0), 10));
    Game::units.push_back(new Unit(Configs::meta_units["m2a3"], QVector3D(4, 0.7, 0), 150));
}
...
void Game::step() {
    ...
    units[0]->applyForce(units[0]->vectorDir*units[0]->mass*1, 0);
